  ...
  return (
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <div className="fixed bottom-5 right-5 z-50 flex flex-col gap-3">
        <a
          href={`https://wa.me/${whatsapp}?text=Hi%20UM%20Transport,%20I%20need%20a%20lorry%20service`}
          target="_blank"
          rel="noreferrer"
          className="flex h-14 w-14 items-center justify-center rounded-full bg-green-500 shadow-xl transition hover:scale-110 hover:bg-green-600"
          aria-label="WhatsApp UM Transport"
        >
          <img
        ...
        <a
          href={`tel:${tel}`}
          className="flex h-14 w-14 items-center justify-center rounded-full bg-red-600 text-2xl text-white shadow-xl transition hover:scale-110 hover:bg-red-500"
